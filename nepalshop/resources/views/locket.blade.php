...
>
          ...
          <br>
           ...
           <a href="{{route('watch')}}">WATCHES</a>
             <a href="{{route('bag')}}">BAGS</a>
               <a id="active" href="{{route('locket')}}">LOCKETS</a>
           ...
           <p style="margin-bottom:1px; text-align:center; font-size:12px;"><span style="margin:7px;" class="glyphicon glyphicon-phone-alt"></span>Contact Us: 9876543334 </p>             
                 ...
                 <div class="row" >
                  ...
                  @foreach($locket as $sunaaa)
                           
                            <div class="col-md-3">
 
                             <a href="{{route('order',['id'=> $sunaaa->id])}}"> <img id="myImgs" src="{{$sunaaa->productimage}}" alt="Trolltunga, Norway" width="220 fixed" height="200"  style="margin-left:120px;margin:4px; border-radius:5px;  "  > </a>
      <center>	<h4  style="
            margin-top:0 fixed;
    ...
    font-size:15px;
	font-weight: 400;
      "> {{$sunaaa->productname}} <br> {{$sunaaa->productprice}}   </h4> </center>
