...
>
       ...
       <img src = "../image/a.png" class="left-image">
          <br>
           ...
           <a href="{{route('watch')}}">WATCHES</a>
             <a id="active" href="{{route('bag')}}">BAGS</a>
           ...
           <p style="margin-bottom:1px; text-align:center; font-size:12px;"><span style="margin:7px;" class="glyphicon glyphicon-phone-alt"></span>Contact Us: 9876543334 </p>             
                 ...
                 <div class="row" >
                  ...
                  @foreach($bag as $sunaa)
                           
                            <div class="col-md-3">
 
                               <a href="{{route('order',['id'=> $sunaa->id])}}"> <img id="myImgs" src="{{$sunaa->productimage}}" alt="Trolltunga, Norway" width="220 fixed" height="200"  style="margin-left:120px;margin:4px; border-radius:5px;  "  > </a>
      <center>	<h4  style="
            margin-top:0 fixed;
    ...
    font-size:15px;
	font-weight: 400;
      "> {{$sunaa->productname}} <br> {{$sunaa->productprice}}   </h4> </center>
